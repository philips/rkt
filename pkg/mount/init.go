...
import (
	...
	"github.com/coreos-inc/rkt/pkg/label"
	"github.com/coreos-inc/rkt/pkg/mount/nodes"
)
...
// new mount namespace.
func InitializeMountNamespace(rootfs string, sysReadonly bool, mountConfig *MountConfig) error {
	var (
		err  error
	...
	if err = syscall.Chroot("."); err != nil {
		return fmt.Errorf("Failed to chroot to %s: %v", rootfs, err)
	}
